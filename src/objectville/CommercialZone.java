...
public class CommercialZone extends Zone {
    ...
    public void update() {
        ...
        boolean canLevel3 = canLevel2 && population > 0 && goods > 0;
        ...
        else                 output = 2 * m + Math.min(population, goods);
    ...
    @Override public String getDisplayName()  { return "Commercial"; }
    @Override public String getResourceName() { return "lifestyle"; }
}
